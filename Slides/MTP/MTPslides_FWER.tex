...
\rbf{Family 2}
$F_2 = \{H_{k+1}, \dots, H_{k+j}\}$, null hypotheses
...
\begin{frame}
\frametitle{Gatekeeping procedure \footnote{Dmitrienko, A., Offen, W. W., and Westfall, P. H. (2003). Gatekeeping strategies for clinical trials that do not require all primary effects to be significant. Statistics in medicine, 22(15), 2387-2400.}}
...
\end{tikzpicture}
\end{figure}
Family 1: Treatment versus Placebo on cognition and clinical global scale

Family 2: Treatment versus Placebo on biochemical and imaging marker
\end{frame}

\begin{frame}
\frametitle{Gatekeeping strategies}
    PUT SERIAL EXAMPLE AS PARALLEL
\end{frame}
